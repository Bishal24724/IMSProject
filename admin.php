            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						' <a href="admin.php" class="btn btn-success btn-sm pull-right" style="border-radius:0%">Go Back </a>':'<a href="admin.php?action=add" class="btn btn-danger btn-sm pull-right" style="border-radius:0%">
