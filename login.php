         ...
         <div class="row ">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body bg-primary" style="margin-top:70px; box-shadow: 5px 10px #888888;">
							  <h3 class="myhead">Institute management System</h3>
                                <form role="form" action="login.php" method="post">
									...
									<div class="form-group input-group">
                                     ...
                                     <input type="button" onclick="window.location.href='student/index.php'" value="Switch Student Login" style="background-color:red">
                                    </form>
                            </div>
