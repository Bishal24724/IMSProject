            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						' <a href="course.php" class="btn btn-success btn-sm pull-right" style="border-radius:0%">Go Back </a>':'<a href="course.php?action=add" class="btn btn-danger btn-sm pull-right" style="border-radius:0%">
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-success">
						...
						<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" pattern="^[A-Za-z]+(?:\s+[A-Za-z]+|[A-Za-z]+\s*[0-9]+\s*[A-Za-z]+)*$" title="Only letter are allowed in begining" id="course" name="course"  value="<?php echo $course;?>"  />
								</div>
							</div>
