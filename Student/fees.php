...
<div id="page-wrapper">
        ...
        <h5 style="margin-top:20px">Mega Institute Management System</h5><br>
        <small>
        Address: Devinagar, Butwal<br>
        Telephone number: 071*******<br>
        Email Address: mega@gmail.com<br>
</small>
                                    ...
                                    $sql="SELECT * FROM student WHERE username = '$username'";
                                     ...
                                     while($r = $q->fetch_assoc())
                                     {
                                        ...
                                        <form action="https://uat.esewa.com.np/epay/main" method="POST">
                                            ...
                                            <input value="http://localhost/Insitiutemanagementsystem/page/esewa_payment_success.php" type="hidden" name="su">
                                            <input value="http://localhost/Insitiutemanagementsystem/student/fees.php" type="hidden" name="fu">
